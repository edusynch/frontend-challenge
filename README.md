...
- Os dados das crypto moedas no topo da página deverão ser carregados da API Rest (https://)
- O Banner do topo deverá ser em forma de carrossel (Mais detalhes no figma)
- Os dados das crypto moedas na seção de "Top Cryptos" deverão ser carregados da API Rest (https://)
...
- O formulário de Newsletter no rodapé da página deverá ter interação a API Rest (https://)
...
- O topo da página deverá ter as informações do usuário (Avatar e Nome, esses dados deverão ser consumidos da API Rest - https:// );
